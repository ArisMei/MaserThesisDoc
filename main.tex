...
\usepackage{subfigure} % Para insertar subfiguras.
...
\fancyhead[RO]{Clasificación y predicción de la evolución de la bronquiolotis en pacientes pediátricos mediante el uso de datos de monitorización continua} % Texto que se coloca en el encabezado de las páginas impares (O -> 'Odd', o impar) a la izquierda (R -> 'Odd')
...
% Se define el valor de ciertos parámetros de listings para adaptar dicho paquete a código escrito en R:
...
\includepdf[fitpaper=true]{Portada_TFG.pdf}
...
La bronquiolitis aguda es una enfermedad respiratoria de origen vírico que afecta a niños menores de dos años. Se caracteriza por una inflamación de los bronquiolos que provoca una obstrucción de los mismos y una dificultad respiratoria. La base de datos proporcionada por el Hospital Gregorio Marañón contiene información de 79 pacientes con bronquiolitis aguda, de los cuales 18 necesitaron soporte respiratorio mediante oxigenación de alto flujo y 7 acabaron en la UCIP, todos los pacientes que acabaron en la UCIP fueron anteriormente con oxigenación de alto flujo. 

El objetivo de este trabajo es realizar un análisis descriptivo de los datos proporcionados y buscar un modelo que clasifique a los pacientes en función de su gravedad y de esta forma poder predecir la necesidad de ingreso en la Unidad de Cuidados Intensivos (UCIP) y la necesidad de suministrar oxigenación de alto flujo (OAF). La bronquilitis.
...
% ---------------- Tercer anexo --------------- %
\input{lib/zanexo3.tex}
\newpage

% ---------------- Cuarto anexo --------------- %
\input{lib/zanexo4.tex}
\newpage
