...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.75]{./img/Heart-Rate-HGSDA.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.75]{./img/SatO2-HGSDA.png}
...
\begin{figure}[H]
    ...
    \caption{Diagrama de Venn de los pacientes que han sido trasladados a la UCIP y los que han recibido OAF}
