...
\begin{enumerate}
    ...
    \item \textbf{Cálculo de Medias:} Calcular de manera automatizada las medias de \textit{Frecuencia Respiratoria} y \textit{Flujo de Oxígeno} cada hora.
...
Se ha realizado un estudio de los datos faltantes en el estudio. Este estudio ha consistido en determinar que pacientes y variables tenían un alto número de datos faltantes y eliminarlos del estudio. 
